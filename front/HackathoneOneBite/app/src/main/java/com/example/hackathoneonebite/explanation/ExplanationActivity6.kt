...
import com.example.hackathoneonebite.databinding.ActivityExplanation6Binding

class ExplanationActivity6 : AppCompatActivity() {
    lateinit var binding: ActivityExplanation6Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityExplanation6Binding.inflate(layoutInflater)
