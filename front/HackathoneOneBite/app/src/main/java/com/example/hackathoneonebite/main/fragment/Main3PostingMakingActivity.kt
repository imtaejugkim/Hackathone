...
class Main3PostingMakingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        requestNumber = intent.getIntExtra("requestNumber", 0)
        Log.d("requestNumber",requestNumber.toString())
        imagesFill = Array(4) { "" }
